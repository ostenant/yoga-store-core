...
<div class="w ofc case">
	<h2 class="h2 h2_r mt"><em title="收货人信息">收货人信息      [<a href="/buyer/toAddress.shtml"><font style="color:blue;">修改</font></a>]</em><cite></cite></h2>
	<div class="box bg_white">
		<dl class="distr">
			<dd>${address.name}   ${address.phone} <span style="margin-left: 30px">${address.city}${address.addr}</span></dd>
		</dl>
	</div>
