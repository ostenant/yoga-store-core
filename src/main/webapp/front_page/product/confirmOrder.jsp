...
<div class="w ofc case">
	...
	<div class="confirm">
		...
		<div class="ofc">
			...
			<a href="" title="查看订单"  class="inb btn120x30c" style="margin-left: 520px;margin-right: 20px;margin-top: 75px;margin-bottom: 50px;text-align: center;">查看订单</a>
			<a href="/product/display/list.shtml" title="返回主页" class="inb btn120x30c">返回主页</a>
		</div>
	</div>
</div>
</body>
