                     ...
                     <div class="nav">
                     	  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td>
                                	<ul class="nav-menu">
                                    	<li class="current" id="tb_11" onclick="HoverLi(11);"><a href="">首页</a></li>
										<li class="sep"></li><li class="normal" id="tb_12" onclick="HoverLi(12);" ><a href="/admin/frame/product_main.do" target="mainFrame">商品</a></li>
										<li class="sep"></li><li class="normal" id="tb_13" onclick="HoverLi(13);" ><a href="/admin/frame/order_main.do" target="mainFrame">订单</a></li>
										<li class="sep"></li><li class="normal" id="tb_14" onclick="HoverLi(14);" ><a href="" >支付</a></li>
										<li class="sep"></li><li class="normal" id="tb_15" onclick="HoverLi(15);" ><a href="" >资源</a></li>
										<li class="sep"></li><li class="normal" id="tb_16" onclick="HoverLi(16);" ><a href="" >辅助</a></li>
										<li class="sep"></li><li class="normal" id="tb_17" onclick="HoverLi(17);" ><a href="" >维护</a></li>
										<li class="sep"></li><li class="normal" id="tb_18" onclick="HoverLi(18);" ><a href="" >生成</a></li>
										<li class="sep"></li><li class="normal" id="tb_19" onclick="HoverLi(19);" ><a href="" >用户</a></li>
										<li class="sep"></li><li class="normal" id="tb_20" onclick="HoverLi(20);" ><a href="" >配置</a></li>
                                    </ul>
                                </td>
                              </tr>
                            </table>
