...
<div class="body-box" style="float:right">
	<form id="jvForm" action="/admin/product/brand/editBrand.do" method="post" enctype="multipart/form-data">
			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<img width="100" height="100" id="allImgUrl" src="${baseUrl}${brand.imgUrl}"/>
			...
			<tbody>
				<tr>
					<td class="pn-fbutton" colspan="2">
						<input type="submit" class="submit" value="修改"/> &nbsp; <input type="reset" class="reset" value="重置"/>
					</td>
				</tr>
			</tbody>
		</table>
