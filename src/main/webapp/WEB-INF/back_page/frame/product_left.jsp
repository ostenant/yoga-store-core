...
<%@ include file="/WEB-INF/back_page/date.jsp" %>
     <ul class="w-lful">
		<li><a href="/admin/product/product/list.do?isShow=0" target="rightFrame">商品管理</a></li>
		<li><a href="/admin/product/brand/list.do?isDisplay=1" target="rightFrame">品牌管理</a></li>
