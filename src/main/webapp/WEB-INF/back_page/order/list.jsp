...
<table cellspacing="1" cellpadding="5" border="0" width="100%" class="pn-ltable">
	...
	<tbody class="pn-ltbody">
		<c:forEach items="${orders }" var="order">
			<tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
				<td align="center"><input type="checkbox" name="ids" value="73"/></td>
				...
				<td align="center"></td>
				<td align="center">
					<input class="query" id="${product.id}" type="button" value="查看" onclick="window.location.href='/admin/order/view/detail.do?id=${order.id }'"/>
				</td>
			</tr>
		</c:forEach>
