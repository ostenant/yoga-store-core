...
<div class="bar"><div class="bar_w">
	...
	<ul class="r uls">
	<li class="dev">您好,<c:if test="${not empty BUYER_ID}">${BUYER_ID.username},</c:if>欢迎来到馨灵购物商城！
	</li>
...
<div class="w loc">
	<div class="h-title">
		<div class="h-logo"><a href=""><img src="/res/img/pic/logo-1.png"  style="width: 180px;height: 30px;"/></a></div>
	    <div class="h-search">
	      	<input type="text" />
